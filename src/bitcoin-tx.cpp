...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s unitedcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unitedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unitedcoin transaction") + "\n" +
              "  unitedcoin-tx [options] -create [commands]   " + _("Create hex-encoded unitedcoin transaction") + "\n" +
              "\n";
