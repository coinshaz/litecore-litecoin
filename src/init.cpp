...
void Shutdown()
{
    ...
    RenameThread("unitedcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/unitedcoin-project/unitedcoin>";
    const std::string URL_WEBSITE = "<https://unitedcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("unitedcoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Unitedcoin version %s\n", FormatFullVersion());
}
