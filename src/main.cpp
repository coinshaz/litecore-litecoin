...
#if defined(NDEBUG)
# error "Unitedcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Unitedcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s UTC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("unitedcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Unitedcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Unitedcoin: (mainnet >= 710000, regtest and testnet uses supermajority)
